...
#######################################################################################################
#######################################################################################################
#      BELOW IS A COMMENTED SECTION THAT WILL ALLOW FOR GENERALIZED USAGE IN THE FUTURE PLS IGNORE
#######################################################################################################
#######################################################################################################
# choice1=raw_input("Would you like to look at globular clusters or Galaxies? \nPlease enter GC for globular clusters or GAL for galaxies. \n")
# if choice1 == 'GC':
...
#     url='http://api.sdss3.org/spectrumQuery?ra=250.496720585d&dec=36.4623929501&radius=360'
# if choice1 == 'GAL':
